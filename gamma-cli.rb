...
class GammaCli < Formula
  ...
  devel do
    url "https://github.com/orbs-network/homebrew-devtools/releases/download/v0.6.1/gammacli-mac-v0.6.1.tar.gz"
    sha256 "a78bde274392ac27a1e539c4a6576eafe0a59027bb437ab8cc1bb6e05fe512cd"
  end
